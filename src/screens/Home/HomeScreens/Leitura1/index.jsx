    ...
    return(
        <Container>
            ...
            <Text style={{fontSize: 18, marginTop: 10, textAlign: "center", margin: 15}}> 
                COMO LIDAR COM A RAIVA A PARTIR DA PSICOLOGIA DA ATENÇÃO PLENA
            </Text>
            ...
            <Text style={{fontSize: 16, marginTop: 0, textAlign: "justify", margin: 15}}>
...
Algo ocorre, ficamos com raiva, e a mantemos por um longo tempo, ruminando-a. Quem sabe até por toda a vida! Tal atitude o Buddha compara a alguém que faz riscos profundos em uma rocha. 
            </Text>

            <Text style={{fontSize: 16, marginTop: 0, textAlign: "justify", margin: 15}}>
Há, então, a raiva que fica por um tempo, mas a pessoa é rápida em deixá-la passar. Isso é como alguém que escreve na areia ou num solo macio. As marcas logo serão apagadas pelo vento ou pela água. Tal pessoa, ainda que fique com raiva, é macia e flexível por dentro, e não dá muita margem para a raiva se perpetuar. 
            </Text>

            <Text style={{fontSize: 16, marginTop: 0, textAlign: "justify", margin: 15}}>
Finalmente, há aquela que é como alguém que escreve na água, tão logo os traços de irritação e descontentamento surgem em sua mente logo são apagados, pois ela não segura esses traços por meio da repetição do pensamento e do tomar tudo como sendo pessoal.
            </Text>

            <Text style={{fontSize: 20, marginTop: 10, marginLeft: 15, fontWeight: "bold"}}> Lidando com ela </Text>
            <Linha2 />
            <Text style={{fontSize: 16, marginTop: 10, textAlign: "justify", margin: 15}}>
Como você lida com sua raiva? Se você se percebe no primeiro ou no segundo tipo, o treinamento em mindfulness lhe ensinará em primeiro lugar a se distanciar emocionalmente da raiva na medida necessária para vê-la um pouco mais claramente. 
            </Text>

            <Text style={{fontSize: 16, marginTop: 0, textAlign: "justify", margin: 15}}>
Se você tentar suprimi-la irá apenas adiar o problema, além de colaborar para aumentar sua força subconsciente. Se você simplesmente expressar a raiva, estará justificando sua reação e, portanto, fortalecendo-a conscientemente. Ter mindfulness nesse momento implica em estar presente com a raiva, permitir seu aparecimento e reconhecimento na mente, mas sem reagir positiva ou negativamente.
            </Text>

            <Text style={{fontSize: 16, marginTop: 0, textAlign: "justify", margin: 15}}>
Ver a raiva sem reagirmos a ela nos permitirá compreendê-la num sentido mais profundo, talvez percebendo nossos preconceitos e pré-julgamentos, as noções de eu e propriedade que mantemos na mente, nosso senso de importância e nossa fragilidade. 
            </Text>

            <Text style={{fontSize: 16, marginTop: 0, textAlign: "justify", margin: 15}}>
Aquilo que acreditamos, nossas crenças e julgamentos, alteram a forma como interpretamos os fatos que nos acontecem. O que pensamos de nós mesmos molda nossas ansiedades e nossa dor. Tudo isso deve ser percebido com compaixão em relação a nós mesmos.
            </Text>
