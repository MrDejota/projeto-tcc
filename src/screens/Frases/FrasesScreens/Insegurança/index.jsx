    ...
    return(
        <Container>
            ...
            <ScrollView> 
                ...
                <Text style={{textAlign:'justify', fontSize: 14, margin: 10}} >     Você já percebeu que a ansiedade é o reflexo daquilo que 
                ...
                <Text style={{textAlign:'justify', fontSize: 14, margin: 10}} >     Por isso, sempre que esses pensamentos catastróficos surgirem, 
                ...
                <Text style={{textAlign:'justify', fontSize: 14, margin: 10}} >     Ninguém é perfeito, e todos nós temos pontos que ainda precisam
